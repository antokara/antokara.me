...
const parseXML = (text, options = null) => {
  ...
  if (opts.aspect.width === null) {
    // if no width attribute was found but we have the viewBox
    if (width === null && viewBox !== null) {
      [width] = viewBox;
    }
    opts.aspect.width = width;
  }
  if (opts.aspect.height === null) {
    opts.aspect.height = height;
  ...
  if (opts.aspect.width === null || opts.aspect.height === null) {
  ...
  if (viewBox === null) {
    viewBox = {
      minX: 0,
      minY: 0,
      width: opts.aspect.width,
      height: opts.aspect.height,
    };
  }
  ...
  canvas.width = opts.aspect.width;
